...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $email_subject = "Schedule Demo Submission - Grinders (English)";

    if ( !empty($_POST) ) {
        $codedb_user = "clecowmd_demo";
        $password = "aVF0jHcP26dA";
        $database = "clecowmd_demodb";
        $server = "localhost";
    ...
    <main role="main" class="container-fluid thank-you" data-spy="scroll" data-target="#homeNav" data-offset="90">
        <section id="thankyou">
            <div class="container">
                ...
                <p>A sales representative will get in contact with you shortly.</p>
